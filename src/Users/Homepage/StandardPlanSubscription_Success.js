...
function StandardPlanSubscitionSuccess() {
  ...
  if (sessionid !== '' || sessionid !== null) {
    dispatch(
      standardplanmonthlysessionid(formData, (res) => {
        ...
        <div className="main-container">
          ...
          <div className="main">
            ...
            >
              ...
              >
                {' '}
                Your are Successfully taken the standard plan monthly
...
export default StandardPlanSubscitionSuccess
