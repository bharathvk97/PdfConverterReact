...
function ProPlanSubscitionSuccessYearly() {
  ...
  if (sessionid !== '' || sessionid !== null) {
    dispatch(
      proplanyearlysessionid(formData, (res) => {
        ...
        <div className="main-container">
          ...
          <div className="main">
            ...
            >
              ...
              >
                {' '}
                Your are Successfully taken the pro plan yearly subscription
                enjoy it.{' '}
              </p>{' '}
              <Link
                to="/homepageuser"
...
export default ProPlanSubscitionSuccessYearly
