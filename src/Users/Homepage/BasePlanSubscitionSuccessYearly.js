...
function BasePlanSubscitionSuccessYearly() {
  ...
  if (sessionid !== '' || sessionid !== null) {
    dispatch(
      baseplanyearlylysessionid(formData, (res) => {
        // console.log(res)
        ...
        <div className="main-container">
          ...
          <div className="main">
            ...
            >
              ...
              >
                {' '}
                Your are Successfully taken the base plan yearly subscription
                enjoy it.{' '}
              </p>{' '}
              <Link
                to="/homepageuser"
...
export default BasePlanSubscitionSuccessYearly
