...
function BaseplanmonthlyToStandardplanmonthly() {
  ...
  //     }),
  //   )
  // const temp = useSelector(getuserdetailsforupdate);

  // useEffect(() => {
  //   console.log("redux storage", temp);
  // }, []);
      ...
      <div className="main-container">
        ...
        <div className="main">
          ...
          >
            ...
            >
              {" "}
              Successfully changed Base plan monthly to Standard plan Monthly
            </p>{" "}
            <Link
              to="/homepageuser"
...
export default BaseplanmonthlyToStandardplanmonthly;
