...
function BaseplanyearlyToStandardplanyearly() {
      ...
      <div className="main-container">
        ...
        <div className="main">
          ...
          >
            ...
            >
              {" "}
              Successfully changed Base plan Yearly to Standard plan yearly
            </p>{" "}
            <Link
              to="/homepageuser"
...
export default BaseplanyearlyToStandardplanyearly;
