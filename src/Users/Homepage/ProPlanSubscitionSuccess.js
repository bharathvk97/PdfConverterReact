...
function ProPlanSubscitionSuccess() {
  ...
  if (sessionid !== '' || sessionid !== null) {
    dispatch(
      proplanmonthlysessionid(formData, (res) => {
        ...
        <div className="main-container">
          ...
          <div className="main">
            ...
            >
              ...
              >
                {' '}
                Your are Successfully taken the pro plan monthly subscription
                enjoy it.{' '}
              </p>{' '}
              <Link
                to="/homepageuser"
...
export default ProPlanSubscitionSuccess
